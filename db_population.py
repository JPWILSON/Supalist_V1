...
session.add(h2)
session.commit()
h3 = HeadingItem(name="Date of birth", description="", entry_data_type = 3, votes=0, lists= l1, user=user3)
session.add(h3)
session.commit()
...
session.add(h6)
session.commit()
h7 = HeadingItem(name="Founding Location", description="self explanatory", entry_data_type = 1, votes=0, lists= l2, user=user3)
session.add(h7)
session.commit()
...
session.add(h10)
session.commit()
h11 = HeadingItem(name="Date declared", description="self explanatory", entry_data_type = 3, votes=0, lists= l3, user=user3)
session.add(h11)
session.commit()
...
session.add(h15)
session.commit()
h16 = HeadingItem(name="Date built", description="self explanatory ", entry_data_type = 3, votes=0, lists= l4, user=user3)
session.add(h16)
session.commit()
...
session.add(r5)
session.commit()
r6 = Row(votes = 0, lists = l2, user=user3)
session.add(r6)
session.commit()
...
session.add(r7)
session.commit()
r8 = Row(votes = 0, lists = l3, user=user3)
session.add(r8)
session.commit()
...
#list1 row1
entry1 = ShortTextEntry(entry="Jean-Paul", votes=0, heading =h1 , lists =r1 , user=user3)
session.add(entry1)
session.commit()
...
session.add(entry6)
session.commit()
entry7 = DateEntry(entry="1984-02-19", votes=0, heading =h3 , lists =r2 , user=user3)
session.add(entry7)
session.commit()
...
session.add(entry11)
session.commit()
entry12 = TwoDecimal(entry="50.00", votes=0, heading =h4 , lists =r3 , user=user3)
session.add(entry12)
session.commit()
...
session.add(e13)
session.commit()
e14 = DateEntry(entry="2012-05-25", votes=0, heading =h6 , lists =r4 , user=user3)
session.add(e14)
session.commit()
...
# list2 row2
e17 = ShortTextEntry(entry="JPMorgan", votes=0, heading =h5 , lists =r5, user=user3)
session.add(e17)
session.commit()
e18 = DateEntry(entry="1918-05-25", votes=0, heading =h6 , lists =r5, user=user3)
session.add(e18)
session.commit()
...
session.add(e22)
session.commit()
e23 = ShortTextEntry(entry="London, England", votes=0, heading =h7 , lists =r6, user=user3)
session.add(e23)
session.commit()
...
# list3 row1
e25 = ShortTextEntry(entry="Weimaraner", votes=0, heading =h9 , lists =r7, user=user3)
session.add(e25)
session.commit()
...
session.add(e27)
session.commit()
e28 = TwoDecimal(entry="65", votes=0, heading =h12 , lists =r7, user=user3)
session.add(e28)
session.commit()

# list3 row2
e29 = ShortTextEntry(entry="Dalmation", votes=0, heading =h9 , lists =r8, user=user3)
session.add(e29)
session.commit()
e30 = ShortTextEntry(entry="Dalmatia, Croatia", votes=0, heading =h10 , lists =r8, user=user3)
session.add(e30)
session.commit()
e31 = DateEntry(entry="1500-01-02", votes=0, heading =h11 , lists =r8, user=user3)
session.add(e31)
session.commit()
e32 = TwoDecimal(entry="55", votes=0, heading =h12 , lists =r8, user=user3)
session.add(e32)
session.commit()
...
session.add(e34)
session.commit()
e35 = DateEntry(entry="1908-01-25", votes=0, heading =h11 , lists =r9, user=user3)
session.add(e35)
session.commit()
...
session.add(e39)
session.commit()
e40 = DateEntry(entry="1931-05-31", votes=0, heading =h16 , lists =r10 , user=user3)
session.add(e40)
session.commit()
...
session.add(e44)
session.commit()
e45 = DateEntry(entry="1930-01-01", votes=0, heading =h16 , lists =r11 , user=user3)
session.add(e45)
session.commit()
e46 = ShortTextEntry(entry="NYC, USA", votes=0, heading =h17 , lists =r11 , user=user3)
session.add(e46)
session.commit()

# list4 row3
e47 = ShortTextEntry(entry="Burj Khalifa", votes=0, heading =h13 , lists =r12 , user=user3)
session.add(e47)
session.commit()
e48 = ShortTextEntry(entry="Adrian Smith", votes=0, heading =h14 , lists =r12 , user=user3)
session.add(e48)
session.commit()
e49 = TwoDecimal(entry="1500000000.00", votes=0, heading =h15 , lists =r12 , user=user3)
session.add(e49)
session.commit()
e50 = DateEntry(entry="2010-01-04", votes=0, heading =h16 , lists =r12 , user=user3)
session.add(e50)
session.commit()
